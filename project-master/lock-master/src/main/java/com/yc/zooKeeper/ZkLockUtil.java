...
//    private CountDownLatch countDownLatch = null;
    ...
    private static final String NODE_NAME = "/test_simple_lock5";
    ...
    public boolean tryLock() {
        try {
            ...
            System.out.println("lock failed threadId =" + Thread.currentThread().getId());
    ...
    void waitLock() {
        ...
        System.out.println("wait threadId =" + Thread.currentThread().getId());
        ...
        if (zkClient.exists(NODE_NAME)) {
            try {
                ...
                System.out.println("wait threadId =" + Thread.currentThread().getId() + "等待获取锁资源");
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }
